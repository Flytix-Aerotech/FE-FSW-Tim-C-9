                ...
                <div className="relative p-6 flex-auto">
                  <List className="flex">
                    <ListItem
                      ...
                      $
                    >
                      <span className="mr-2 font-bold">Harga</span>
                      <span className="font-sans">- Termurah</span>
                    ...
                    <ListItem className="w-full hover:bg-purple-500 hover:text-white">
                      <span className="mr-2 font-bold">Durasi</span>
                      <span className="font-italic">- Terpendek</span>
                      <ListItemSuffix>
                    ...
                    <hr className="border-t border-gray-300" />
                    <ListItem className="w-full hover:bg-purple-500 hover:text-white">
                      <span className="mr-2 font-bold">Keberangkatan</span>
                      <span className="font-italic">- Paling Awal</span>
                      <ListItemSuffix>
                        <CheckCircleIcon className="icon-purple h-5 w-5 ml-auto" />
                      </ListItemSuffix>
                    </ListItem>
                    ...
                    <ListItem className="w-full hover:bg-purple-500 hover:text-white">
                      <span className="mr-2 font-bold">Keberangkatan</span>
                      <span className="font-italic">- Paling Akhir</span>
                      <ListItemSuffix>
                        <CheckCircleIcon className="icon-purple h-5 w-5 ml-auto" />
                      </ListItemSuffix>
                    </ListItem>
                    <hr className="border-t border-gray-300" />
                    <ListItem className="w-full hover:bg-purple-500 hover:text-white">
                      <span className="mr-2 font-bold">Kedatangan</span>
                      <span className="font-italic">- Paling Awal</span>
                      <ListItemSuffix>
                        <CheckCircleIcon className="icon-purple h-5 w-5 ml-auto" />
                      </ListItemSuffix>
