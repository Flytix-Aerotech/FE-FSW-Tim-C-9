...
const NotificationPage = ({ notificationsData }) => {
  return (
    <>
      <NavbarComplex />
...
export const NotificationItem = ({ type, message, additional_msg, date, readStatus, dataIndex, totalData }) => {
  return (
    <div className="">
      ...
      {dataIndex !== totalData - 1 && <hr className="border-solid border-gray-500 m-3 w-full"></hr>}
    </div>
  );
};
